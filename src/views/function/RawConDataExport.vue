<template>
	<div class="raw-data-main">
		<div class="raw-content">
			<div class="raw-tip"><span class="tip-l"></span><span class="tip-t">原数据导出</span><span class="tip-r">概念筛选专案</span></div>
	...
	export default {
		...
		methods: {
			async getSubjectList() {
				let url = '/api/meta/cptTopic'
				let param = {
					cptGuidList: this.case_id,
			...
			searchExportData() {
				...
				this.$router.push(`/export/raw-con-data-table?case_id=${this.case_id}&case_name=${this.case_name}&subjectId=${queStr}`)
			}
		},
		created() {
